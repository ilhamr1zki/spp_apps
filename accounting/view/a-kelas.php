...
<?php $smk=mysqli_query($con,"SELECT * FROM kelas order by kelas asc ");$vr=1;while($akh=mysqli_fetch_array($smk)){ $jsis=mysqli_num_rows(mysqli_query($con,"SELECT * from siswa where c_kelas='$akh[c_kelas]' ")); ?>
                <tr>
                  ...
                  <td><?php echo $jsis; ?> Siswa</td>
                  <td align="center">
                  <a class="btn btn-success btn-sm" href="<?php echo $basead; ?>siswa/<?php echo $akh['c_kelas']; ?>"><i class="glyphicon glyphicon-user"></i> Lihat Siswa</a>
                  <a class="btn btn-circle btn-primary btn-sm" data-target="#edit<?php echo $akh['c_kelas']; ?>" data-toggle="modal"><i class="glyphicon glyphicon-pencil"></i> Edit</a>
                  <a class="btn btn-circle btn-danger btn-sm" data-target="#hapus<?php echo $akh['c_kelas']; ?>" data-toggle="modal"><i class="glyphicon glyphicon-remove"></i></a></td>
                </tr>
