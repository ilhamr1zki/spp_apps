        ...
        <?php $_SESSION['pesan'] = '';?>
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"> <i class="glyphicon glyphicon-list-alt"></i> Seluruh Mata Pelajaran</h3><span style="float:right;"><a class="btn btn-primary" data-target="#tambah" data-toggle="modal"><i class="glyphicon glyphicon-plus"></i> Tambah Mapel</a></span>
            </div>
            <!-- /.box-header -->
      ...
      <div class="modal-header">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" name="sl" class="form-control" onkeypress="return hanyaangka(event)" value="<?php echo $akh['sl']; ?>">
          </div>
        </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label>NILAI STANDART KELULUSAN</label>
            <input type="text" name="sl" class="form-control" onkeypress="return hanyaangka(event)">
          </div>
        </div>
        <div class="modal-footer">
          <button class="btn btn-primary btn-circle"><i class="glyphicon glyphicon-ok"></i> Simpan</button> 
